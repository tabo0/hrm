...
<div class="container mar ">
    <h1 class="newcenter" align="center"> 录入岗位信息<span style="color: red">*必填</span></h1>
    ...
    <form class="form-horizontal" role="form">
        ...
        <div class="form-group">
            <label for="lastname" class="col-sm-2 control-label">上级岗位<span style="color: red"> *</span></label>
            <div class="col-sm-10">
                <textarea type="text"  rows=4 class="form-control" id="father" placeholder="1~30字符"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="lastname" class="col-sm-2 control-label">岗位职责<span style="color: red"> *</span></label>
            <div class="col-sm-10">
                <textarea type="text"  rows=4 class="form-control" id="zhize" placeholder="20~500字符"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="lastname" class="col-sm-2 control-label">任职资格<span style="color: red"> *</span></label>
            <div class="col-sm-10">
                <textarea type="text"  rows=4 class="form-control" id="zige" placeholder="20~500字符"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="lastname" class="col-sm-2 control-label">岗位权限<span style="color: red"> *</span></label>
            <div class="col-sm-10">
                <textarea type="text"  rows=4 class="form-control" id="quanxian" placeholder="20~500字符"></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="lastname" class="col-sm-2 control-label">岗位工作内容<span style="color: red"> *</span></label>
            <div class="col-sm-10">
                <textarea type="text"  rows=4 class="form-control" id="work" placeholder="20~500字符"></textarea>
            </div>
        </div>
    </form>
    <div class="form-group">
...
<script>
    function  submit(){
        ...
        alert('添加成功!');
        var con = {
            name:name,father:father,zige:zige,zhize:zhize,quanxian:quanxian,work:work,flag:'add',
        };
